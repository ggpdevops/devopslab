...
const Contact = () => {
  ...
  // Set up map after component mounts
  useEffect(() => {
  ...
  return (
    <div className="py-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      <div className="text-center mb-12">
        <h1 className="text-3xl font-bold text-gray-900 sm:text-4xl mb-4">Get in Touch</h1>
        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
          Have questions about our travel services or need assistance planning your next adventure? Reach out to us!
        </p>
      </div>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div>
                  <button
                    ...
                    className="flex items-center justify-center w-full sm:w-auto px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 disabled:opacity-75"
                  >
                    {isSubmitting ? (
                      <span>Sending...</span>
                    ) : (
      ...
      {/* Map Section */}
      <div className="mt-12">
        <div className="bg-gray-100 rounded-lg overflow-hidden h-96 w-full shadow-md">
